...
This final visual takes the percentage of returning after 7 day visits before and after the date ITP was implemented on November 5th, 2020. 
...
- The biggest change is categorizing the date as being 'after' or 'before' the ITP changes. 
```{r, fig.asp=.35, fig.width=8}
prev12 <- prev12 %>%
  mutate(date = lubridate::my(daterangemonth)) 
