...
This function still exists but has been superceded by `aw_auth()`.  While it **does not** require a change right now, I would encourage you to start changing over to the new authentication functions, even if you are still using OAuth. We have added a live-cycle warning to help remind users to do so.  
